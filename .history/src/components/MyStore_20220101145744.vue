  ...
  <div>
    ...
    <el-button @click="addImage">确认添加</el-button>
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="uploadGoods(goodsEditing.name,goodsEditing.price,goodsEditing.img)">确 定</el-button>
      </span>
    </el-dialog>
     <!-- 修改商品信息对话框 -->
    <el-dialog
...
export default {
  ...
  methods: {
    ...
    // 上传商品
    uploadGoods (name, price, img) {
      console.log(this.goodsEditing.name + this.goodsEditing.price)
      this.$axios.post('/business/goodsupload/' + window.sessionStorage.getItem('userid') + '/' + name + '/' + price + '/' + img)
        .then(res => {
          console.log(res)
        })
    },
