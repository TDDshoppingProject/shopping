      ...
      <el-container>
        ...
        <el-aside :width="isCollapse ? '64px' : '200px'">
          ...
          <el-submenu index="1" v-if="this.role === '1'">
            ...
            <!-- 我的店铺 -->
            <el-menu-item index="/businessOrder" @click="jump('/businessOrder')" >
              <i class="el-icon-office-building"></i>
              <span slot="title" style="margin-left: 15px">管理订单</span>
            </el-menu-item>
            <el-menu-item index="/contstore" @click="saveNavState('/contstore')"><i class="el-icon-data-board"></i>管理店铺</el-menu-item>
          </el-submenu>
          </el-menu>
        </el-aside>
        <!-- 右侧内容主体区域 -->
