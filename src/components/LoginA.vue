        ...
        <div class="loginBox">
            ...
            <el-form ref="loginFormRef" class="loginForm" :rules="loginFormRules" :model="loginForm">
                <el-form-item prop="username">
                    <el-input v-model="loginForm.username" prefix-icon="iconfont icon-avatar" placeholder="请输入用户名"></el-input>
               </el-form-item>
    ...
    login () {
      this.$refs.loginFormRef.validate(async valid => {
        ...
        if (valid) {
          ...
          /* if (this.loginForm.username === 'zsa' & this.loginForm.password === '123456') {
